  ...
  window.addEventListener(
    ...
    (event) => {
      ...
      switch (event.key) {
        case "Enter":
          document
            .querySelector(".m-cards .l-grid > *:nth-of-type(2) .f-time")
            .click();
          break;
        case "Escape":
          document
            .querySelector(".m-cards.has-active .is-active .f-time")
            .click();
          break;
        case "Up":
        case "ArrowUp":
        ...
        case "ArrowLeft":
          ...
          if (previous.previousElementSibling !== null) {
            ...
            initial.querySelector(".f-time").click();
            document
              .querySelector(".m-cards .l-grid > *:nth-of-type(9) .f-time")
              .click();
          }
          break;
        case "Down":
  ...
  document.querySelectorAll(".f-time").forEach((item) => {
    ...
    switch (type) {
      case "hour":
        ...
        item.querySelector(".f-time-specs-ms").innerText =
          numberWithCommas(msLeft);
        secondsLeft = Math.floor((end - time) * 0.001);
        item.querySelector(".f-time-specs-s").innerText =
          numberWithCommas(secondsLeft);
        minutesLeft = Math.floor(secondsLeft / 60);
        item.querySelector(".f-time-specs-m").innerText =
          numberWithCommas(minutesLeft);
      ...
      case "day":
        ...
        item.querySelector(".f-time-specs-h").innerText =
          numberWithCommas(hoursLeft);
      ...
      case "week":
        ...
        item.querySelector(".f-time-specs-d").innerText =
          numberWithCommas(daysLeft);
      ...
      case "year":
        ...
        item.querySelector(".f-time-specs-w").innerText =
          numberWithCommas(weeksLeft);
        monthsLeft = Math.floor(daysLeft / 30);
        item.querySelector(".f-time-specs-mo").innerText =
          numberWithCommas(monthsLeft);
      ...
      case "decade":
        ...
        item.querySelector(".f-time-specs-y").innerText =
          numberWithCommas(yearsLeft);
      ...
      case "century":
        ...
        item.querySelector(".f-time-specs-de").innerText =
          numberWithCommas(decadesLeft);
      ...
      case "millenium":
        ...
        diff = year - start;
        amount = diff / 1000;
        item.querySelector(".f-time-specs-y").innerText = numberWithCommas(
          end - year,
        );
        item.querySelector(".f-time-specs-de").innerText = numberWithCommas(
          Math.floor((end - year) / 10),
        );
        item.querySelector(".f-time-specs-c").innerText = numberWithCommas(
          Math.floor((end - year) / 100),
        );
    ...
    if (percentage !== "undefined") {
      ...
      setTimeout(() => {
        item.querySelector(".f-time-circle-progress").style.strokeDashoffset =
          566 - circleAmount + "px";
        item.querySelector(".a-progress-line").style.width = percentage + "%";

        let dynamicWidth = parseInt(
          item.querySelector(".a-progress-line").style.width,
        );
        let hue = Math.floor(199 - (199 / 100) * dynamicWidth);
        let hueLight = hue + 10;

        item.querySelector(".a-progress-line").style.backgroundColor = hslToHex(
          hue,
          56,
          52,
        );
        item.querySelector(".a-progress-line").style.boxShadow =
          "0 0 .5em" + hslToHex(hueLight, 76, 62);
        item.querySelector(".a-progress").style.backgroundColor = hslToHex(
          hue,
          15,
          35,
        );
